...
const Products = () => {
  ...
  const products = [
    {
      name: 'Cureline',
      tagline: 'Enterprise Revenue Cycle Management',
      description: 'A comprehensive revenue cycle management solution that streamlines patient management, eligibility verification, claim generation, submission, and denial management for healthcare providers.',
      features: [
      ...
      stats: { claims: '50M+', hospitals: '200+', uptime: '99.9%' },
    },
    {
      name: 'Tibbiq',
      tagline: 'Smart Healthcare Solutions',
      description: 'An intelligent healthcare platform that connects patient management, appointments, electronic medical records, pharmacy operations, billing, and insurance integration into a single secure ecosystem.',
      features: [
